...
<template>
    <button
        ...
        class="w-full border-l-4 border-yellow-400 bg-yellow-50 px-4 py-3 text-left transition-colors hover:bg-yellow-100 dark:border-yellow-500 dark:bg-yellow-900/40 dark:hover:bg-yellow-900/60"
        @click="handleClick"
