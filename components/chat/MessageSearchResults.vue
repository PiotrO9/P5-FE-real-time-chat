...
<template>
    <div class="flex flex-col">
        ...
        <div v-else class="flex flex-col">
            <div
                class="border-b border-gray-200 px-4 py-2 text-xs text-gray-500 dark:border-gray-700 dark:text-gray-400"
            >
            ...
            <button
                v-if="hasMore"
                type="button"
                class="border-t border-gray-200 px-4 py-2 text-sm text-primary-600 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:text-primary-400 dark:hover:bg-gray-800"
                tabindex="0"
