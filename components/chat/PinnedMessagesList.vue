    ...
    <div class="border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
        ...
        <div v-else class="max-h-96 space-y-2 overflow-y-auto">
            <button
                ...
                class="w-full rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-left text-xs transition-colors hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-800"
            ...
            >
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mb-1 line-clamp-2 text-gray-600 dark:text-gray-400">
                    ...
                    <Icon name="pin" class="size-4 flex-shrink-0" style="color: #ef4444" />
                </div>
            </button>
        </div>
    </div>
