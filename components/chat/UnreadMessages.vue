...
const badgeClasses = computed(() => {
    const base =
        'inline-flex items-center justify-center font-semibold bg-primary-600 text-white rounded-full size-7 px-2';
...
<template>
    ...
    <div v-else>
        <div v-if="hasUnread" class="size-2 rounded-full bg-primary-500" />
    </div>
</template>
